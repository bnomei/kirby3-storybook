...
> TIP: You can use a symlink to make the paths to your assets a bit more readable. Call something like this in your index.php once `symlink(__DIR__ . '/assets/', __DIR__ . '/stories/assets');`
